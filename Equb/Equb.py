...
# ************************************* payment form **********************************************************
    ...
    payment_search_label.grid(row=1,column=0,padx=3,pady=3,sticky='e')
    payment_search_label.bind('<Button-1>',toggle_search)
    payment_search_entry=ttk.Entry(payment_frame,width=30)
    payment_search_entry.grid(row=1,column=0,padx=3,pady=3,sticky='w')
...
# styles.map('TButton',background=[('hover','blue'),('background','white')])
